...
public class WebTable_new extends Base{
     ...
     */
    public List<String> get_all_table_column_headers(){
     ...
     */
    public int get_table_column_count(){
     ...
     */
    public int get_table_column_position(String _col_name){
        return get_all_table_column_headers().indexOf(_col_name) + 1 ;// adding 1 as List is 0 based index
    }

    public int get_table_row_num_based_on_search_keyword(String col_name, String _comp_name){
     ...
     */
    public List<String> get_all_values_by_column_name(String _col_name){
     ...
     */
    public String generate_xpath_expression_dynamically(String _col_name, String _cell_val){
        int _col_position = get_table_column_position(_col_name) ;
        int _num_of_cols = get_table_column_count();
        String _xpath_builder;
    ...
    public String get_xpath_expression_from_By(By xpath){
        String[] _xpath_split = xpath.toString().split(":");
        return _xpath_split[1].trim();
    }

    public void click_select_cell_in_table(String _col_name, String _cell_val) {
     ...
     */
    public String get_mapped_value(String _primary_col_header, String _primary_col_val, String _query_col){
